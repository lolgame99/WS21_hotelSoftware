    ...
    <header>
      		...
      		<Row>
      			...
      			<Col xs={6}>
      				...
      				<Row>
      					<Col>
      						<br/>
      						<Form.Group controllId="createBooking.catSingle">
      							<Form.Control type="text" placeholder="Single room" disabled/>
      						</Form.Group>
      					</Col>
      					<Col>
      						<br/>
      						<Form.Group controllId="createBooking.singleRoomCount">
      				...
      				<Row>
      					<Col>
      						<br/>
      						<Form.Group controllId="createBooking.catDouble">
      							<Form.Control type="text" placeholder="Double room" disabled/>
      						</Form.Group>
      					</Col>
      					<Col>
      						<br/>
      						<Form.Group controllId="createBooking.doubleRoomCount">
      							<Form.Control type="number"/>
      						</Form.Group>
      					</Col>
      				</Row>
      ...
      <footer>
    	...
    	<Col className="content">
      		Hier kommen die Kontaktdaten hin
      	</Col>
      	<br/>
      </footer>
    </div>
