...
public class TestData implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		roomRepository.addRoom(Room.create(new RoomId("105"), RoomStatus.AVAILABLE, categoryUUID[0]));
		roomRepository.addRoom(Room.create(new RoomId("106"), RoomStatus.AVAILABLE, categoryUUID[0]));
		...
		roomRepository.addRoom(Room.create(new RoomId("204"), RoomStatus.AVAILABLE, categoryUUID[1]));
		roomRepository.addRoom(Room.create(new RoomId("205"), RoomStatus.AVAILABLE, categoryUUID[1]));
		roomRepository.addRoom(Room.create(new RoomId("206"), RoomStatus.AVAILABLE, categoryUUID[1]));
		...
		roomRepository.addRoom(Room.create(new RoomId("305"), RoomStatus.AVAILABLE, categoryUUID[2]));
		roomRepository.addRoom(Room.create(new RoomId("306"), RoomStatus.AVAILABLE, categoryUUID[2]));
