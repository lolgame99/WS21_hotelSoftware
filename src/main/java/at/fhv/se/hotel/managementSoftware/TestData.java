...
public class TestData implements ApplicationRunner{
	...
	public void run(ApplicationArguments args) throws Exception {
		customerRepository.addCustomer(new Customer("1", "Ulrich", "Vogler", new Address("Kantstraﬂe", "32", "Rochlitz", "09301", "Deutschland"), "UlrichVogler@rhyta.com", "+493737105579", Gender.MALE));
